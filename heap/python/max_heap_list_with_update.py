# This file uses the code from the book Competitive Programming in Python 128 algorithms...
# The code has been modified for max-heap
# This uses siftUp to push elements into the heap
# and siftDown to pop element from the heap 
# Which is slower in theory compared to using siftDown during build
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
A max heap
